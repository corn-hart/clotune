        ...
        if decoded_message:
            ...
            if (serial_buffer[-1][0] != 'b'):
                ...
                if   (serial_buffer[-1][0:2] == 'f1'):
                    ...
                    serial_buffer.append(numpy.clip(abs(float(decoded_message[3:])) / 950,0,1))
...
def main():
    ...
    while run:
        ...
        button1_text = button_font.render('KICK', 500, WHITE)
        button2_text = button_font.render('HATS', 500, WHITE)
        button3_text = button_font.render('SUN', 500, WHITE)
        flex1_text = button_font.render('PPONG_L', 500, WHITE)
        flex2_text = button_font.render('PPONG_R', 500, WHITE)
        accelx_text = button_font.render('FLANGR__KICK', 500, WHITE)
        accely_text = button_font.render('FLANGR__SUN', 500, WHITE)
